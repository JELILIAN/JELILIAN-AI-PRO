...
if daytona_config.api_key:
    ...
    daytona = None
    logger.info("Daytona disabled - no API key provided")
...
async def get_or_start_sandbox(sandbox_id: str):
    ...
    if daytona is None:
        logger.warning("Daytona is disabled - cannot get or start sandbox")
        return None
...
def create_sandbox(password: str, project_id: str = None):
    ...
    # Create the sandbox
    if daytona is None:
        logger.warning("Daytona is disabled - cannot create sandbox")
        return None
...
async def delete_sandbox(sandbox_id: str):
    ...
    if daytona is None:
        logger.warning("Daytona is disabled - cannot delete sandbox")
        return False
