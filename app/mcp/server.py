...
class MCPServer:
    ...
    def __init__(self, name: str = "jelilian-ai-pro"):
    ...
    def run(self, transport: str = "stdio") -> None:
        ...
        logger.info(f"Starting JELILIAN AI PRO server ({transport} mode)")
        self.server.run(transport=transport)


def parse_args() -> argparse.Namespace:
    """Parse command line arguments."""
    parser = argparse.ArgumentParser(description="JELILIAN AI PRO MCP Server")
    parser.add_argument(
        "--transport",
        choices=["stdio"],
        default="stdio",
