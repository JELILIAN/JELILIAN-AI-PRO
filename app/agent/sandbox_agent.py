...
class SandboxJelilianAIPro(ToolCallAgent):
    """A versatile general-purpose agent with support for both local and MCP tools."""

    name: str = "SandboxJelilianAIPro"
    description: str = "A versatile AI agent framework that can solve various tasks using multiple sandbox-tools including MCP-based tools"
    ...
    def initialize_helper(self) -> "SandboxJelilianAIPro":
        """Initialize basic components synchronously."""
        self.browser_context_helper = BrowserContextHelper(self)
        return self

    @classmethod
    async def create(cls, **kwargs) -> "SandboxJelilianAIPro":
